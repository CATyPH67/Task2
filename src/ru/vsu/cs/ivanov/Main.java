...
public class Main
{
    ...
    {
        return (isLinesParallel(p1, p2, p3, p4) && isLinesParallel(p1, p3, p2, p4))
            || (isLinesParallel(p1, p3, p2, p4) && isLinesParallel(p1, p4, p2, p3))
            || (isLinesParallel(p1, p4, p2, p3) && isLinesParallel(p1, p2, p4, p3));
    }

    public static boolean isLinesParallel(Point p1, Point p2, Point p3, Point p4)
    {
